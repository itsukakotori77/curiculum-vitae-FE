...
import ColorPickerInput, { ColorPickerProps } from './ColorPickerInput'
import { motion } from 'framer-motion'
import React from 'react'
import { hexToRgba, joinClass } from '@/utils/common'
import { RgbaColor } from 'react-colorful'

export interface ColorPickerForm<T extends FieldValues> extends Omit<HTMLMotionProps<'div'>, 'defaultValue'> {
   name: Path<T>
   control: Control<T>
