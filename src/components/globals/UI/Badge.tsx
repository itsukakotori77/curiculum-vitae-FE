...
const variantsBadge = cva('flex justify-center items-center rounded-full px-2 py-0.5 w-auto',
   {
      variants: {
         intent: {
            primary: ['bg-[#]'],
            secondary: ['bg-orange-100/60 text-black border-3 border-orange-600/70'],
