      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className={cn(
              `fixed z-50 overflow-hidden border border-zinc-950/10 
                      bg-white shadow-lg outline-none dark:border-zinc-50/10 
                      dark:bg-zinc-800 max-w-screen`,
              triggerRect
                ? '' // No centering classes when positioned relative to trigger
                : 'top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2', // Center when no trigger
              className,
            )}
            style={{
              borderRadius: 12,
