...
const cvVariants = cva(
   ...
   "p-5 flex w-full bg-white shadow-lg sample3-container print:shadow-none",
   {
      variants: {
         ...
         printable: {
            print: ['min-h-screen', 'flex', 'justify-center', 'items-start', 'print:bg-white', 'print:py-0', 'print:py-0', 'print:px-0'],
            ...
            >
               ...
               >
                  ...
                  <div
                     ...
                     style={{ width: `${sidebarWidth}%`, background: sidebarColor }}
                  >
                     <div className="flex justify-center p-4 flex-col">
                        ...
                        <div className="flex flex-col my-4">
                           <CVText variant="subtitle" size={textSize} style={{ color: sidebarTextColor }}>
                              CONTACTS
                           </CVText>
                           ...
                           <div className="grid my-2 gap-2">
                              ...
                              {data?.contacts?.phone && (
                                 <div className="flex justify-start items-center gap-2">
                                    <FontAwesomeIcon icon={faWhatsapp} className={cn(iconVariants({ iconSize }))} />
                                    <CVText
                                       variant={variantText}
                                       size={textSize}
                              ...
                              {data?.contacts?.telegram && (
                                 <div className="flex justify-start items-center gap-2">
                                    <FontAwesomeIcon icon={faTelegram} className={cn(iconVariants({ iconSize }))} />
                                    <CVText
                                       variant={variantText}
                                       size={textSize}
                                       className="font-light tracking-wide"
                              ...
                              {data?.contacts?.email && (
                                 <div className="flex justify-start items-center gap-2">
                                    <FontAwesomeIcon icon={faEnvelope} className={cn(iconVariants({ iconSize }))} />
                                    <CVText
                                       variant={variantText}
                                       size={textSize}
                                       className="font-light tracking-wide"
                              ...
                              {data?.contacts?.linkedin && (
                                 <div className="flex justify-start items-center gap-2">
                                    <FontAwesomeIcon icon={faLinkedinIn} className={cn(iconVariants({ iconSize }))} />
                                    <CVText
                                       variant={variantText}
                                       size={textSize}
                                       className="font-light tracking-wide"
                              ...
                              {data?.contacts?.instagram && (
                                 <div className="flex justify-start items-center gap-2">
                                    <FontAwesomeIcon icon={faInstagram} className={cn(iconVariants({ iconSize }))} />
                                    <CVText
                                       variant={variantText}
                                       size={textSize}
                                       className="font-light tracking-wide"
                              ...
                              {data?.contacts?.otherwise && (
                                 <div className="flex justify-start items-center gap-2">
                                    <FontAwesomeIcon icon={faLink} className={cn(iconVariants({ iconSize }))} />
                                    <CVText
                                       variant={variantText}
                                       size={textSize}
                                       className="font-light tracking-wide"
                  ...
                  <div className="main-content lg:w-[75%] w-full">
                     {/* DETAIL */}
                     <div className="border-t-4 border-b-4 border-r-4 p-4" style={{ borderColor: sidebarColor }}>
                        <div className="flex flex-col justify-center items-center gap-2">
                           <CVText variant="title" size={textSize}>
                              {`${data?.firstName.toUpperCase()} ${data?.lastName.toUpperCase()}`}
                           </CVText>
                           <div className="h-2.5 w-1/4" style={{ background: sidebarColor }}></div>
                           <CVText variant="subtitle" size={textSize} className="font-light">
                              {data?.role}
                           </CVText>
                        </div>
                     </div>
                     ...
                     <div className="flex w-full flex-col items-start my-2 py-2 pl-4">
                        ...
                        <div className="group flex gap-x-5 w-full">
                           <div className="relative">
                              ...
                              <span style={{ borderColor: sidebarColor, color: sidebarColor }} className="relative z-10 grid h-10 w-10 place-items-center rounded-full 
                                    bg-white border-4
                                    font-extrabold text-lg"
                              >1</span>
                           </div>
                           <div className="pb-8 text-slate-600 w-full">
                              <div style={{ background: sidebarColor }} className="px-2 py-1 mt-1">
                                 <CVText variant="small" size={textSize} style={{ color: primaryColor }} className="font-bold tracking-wide">
                                    PROFILE
                                 </CVText>
                              </div>
                              <CVText 
                                 ...
                                 {data?.experience?.toReversed()?.map((item: any, key: number) => (
                                    <li key={key}>
                                       <div className="flex flex-col gap-1">
                                          <CVText variant="tiny" size={textSize} className="font-bold">
                                             {`${item?.jobTitle} - ${item?.company}`}
                                          </CVText>
                                          <CVText variant="tiny" size={textSize} className="flex items-center font-medium text-gray-500">
                                             {moment(item?.startDate).format('MMMM, Do YYYY')}
                                             <ChevronRight className="w-4 h-4 mx-1" />
                                             {item?.isCurrent ? 'Current' : moment(item?.endDate).format('MMMM, Do YYYY')}
                                          </CVText>
                                          <CVText variant="tiny" size={textSize} className="mb-2 font-light text-gray-500 text-justify">
                                             {item?.descJob}
                                          </CVText>
                                       </div>
                                    </li>
                                       ...
                                       <div className="flex flex-col gap-1">
                                          ...
                                          {item?.graduatedStatus ? (
                                             <>
                                                ...
                                                <CVText variant="tiny" size={textSize} className="font-normal text-gray-500">
                                                   {`GPA: ${item?.gpa} - ${item?.gpaStatus}`}
                                                </CVText>
                                             </>
                                          ) : (
                                             <CVText variant="small" size={textSize} className="font-normal text-gray-500">
                                                Not Graduated Yet
                                             </CVText>
                                          )}
                                       </div>
                              ...
                              <div className="pb-8 text-slate-600 w-full">
                                 ...
                                 <ul className="space-y-0.5 list-disc pl-4 my-4">
                                    {data?.certification?.map((item: any, key: number) => (
                                       <li key={key}>
                                          <CVText variant="tiny" size={textSize} className="block font-medium text-gray-600">
