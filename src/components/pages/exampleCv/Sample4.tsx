...
const Sample4 = forwardRef<HTMLDivElement, Sample>(
  (
    {
      data,
      size = 'md',
            ...
            <div className="flex flex-col min-w-full p-5">
              ...
              <div className="flex w-full gap-4">
                <div className="w-[70%] flex flex-col gap-2">
                  <div className="flex w-full gap-3 justify-between">
                    <div className="w-2/4">
                      <div className="p-2 border border-black rounded-md flex items-center justify-center">
                        <CVText
                          variant="body"
                          size={textSize}
              ...
              <div className="flex gap-3 mt-4">
                ...
                <div className="w-[30%] flex flex-col gap-2">
                  {/* Education */}
                  <div
                    className="py-3 px-2 border rounded-md w-full"
                    style={{
                      borderColor: primaryColor,
                    }}
                  >
                      ...
                      {data?.skills?.map((item: any, key: number) => (
                        <div className="flex flex-col items-start" key={key}>
                          ...
                          <div className="grid grid-cols-7 w-full gap-0">
                            <div
                              dir="ltr"
                              className="h-2.5 w-full border-none rounde rounded-s-xl"
                              style={{
                                background: ` ${
                                  Boolean(item?.isHasLevel) ? skillColor : ''
                                }`,
                              }}
                            ></div>
                            ...
                            {Array.from({ length: item?.level }, (_, index) => (
                              <div
                                key={index}
                                className={`h-2.5 w-full border-none `}
                                style={{
                                  background: ` ${
