      ...
      <div className="flex flex-col md:flex-row w-full h-full justify-between p-4 md:p-10 box-border">
        ...
        <div className="w-full md:w-[35%] text-center md:text-left">
          ...
          <div className="grid mt-2 gap-2 lg:w-full">
            <Button intent="secondary" className="lg:w-48 lg:h-14 rounded-lg"><span className="font-bold">Get Started</span></Button>
                ...
                <div className="grid gap-3 p-1">
                  <div className="flex justify-between items-center">
                    <Image
                      ...
                      height={10}
                    />
                    <span className="font-black text-4xl text-[#FB7842]">100%</span>
                  </div>
                  <span className="text-md">Its totaly free for you !</span>
                </div>
              </Card>
              <Card className="mt-3 rounded-lg w-full">
                <div className="grid gap-3 p-1">
                  <div className="flex justify-between items-center">
                    <Image
                      ...
                      height={10}
                    />
                    <span className="font-black text-4xl text-[#FB7842]">90%</span>
                  </div>
                  <span className="text-md">We’ll promise you can get job faster !</span>
                </div>
              </Card>
            </div>
          </div>
